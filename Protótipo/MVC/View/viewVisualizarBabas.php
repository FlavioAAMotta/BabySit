...
?>
    ...
    <div class="d-flex flex-wrap align-content-center" id="divTextoTroca">
        ...
        <div class="p-2 flex-wrap align-content-center" id="textoTroca">
            ...
            <p class="p-2" >
                Sou <spam id=""> baba </spam> e desejo procurar por uma <spam id="">família </spam>
            </p>
        ...
        <div class="p-2" id="quadradoTroca">
            ...
            <a class="btn" style="background-color: white;" href="viewVisualizarPais.php">
    ...
    <div style="padding-top: 20px;" id="divCards">
        ...
        <!--CARD 1-->
        <a href="viewPerfilPublicoBaba.php">
            <div class="Card" style="">

                <div class="foto">
                    <img src="../../images/gps2.png" alt="" height="18px" style="margin: 3px; position: absolute;">
