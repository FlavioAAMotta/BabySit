	...
	<div class="info-perfil-wrapper">
		...
		<div class="extra-info-perfil-box">
			<div class="exp-info-formacao">
				...
				<br>
				<p>Descrição:</p>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur dictum, justo vitae congue finibus, justo urna placerat ipsum, quis tincidunt purus est in enim.</p>
				<br>
				<p>Valor/Hora</p>
				<p>R$15,00</p>
			</div>
